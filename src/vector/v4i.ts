...
export class V4i {
  ...
  /**
   * Four scalars or any combination of scalars + V2i + V3i totalling
   * four components. Mirrors GLSL/WGSL `ivec4(...)` promotion.
   */
  constructor();
  constructor(x: number, y: number, z: number, w: number);
  constructor(xy: V2i, z: number, w: number);
  constructor(x: number, yz: V2i, w: number);
  constructor(x: number, y: number, zw: V2i);
  constructor(xy: V2i, zw: V2i);
  constructor(xyz: V3i, w: number);
  constructor(x: number, yzw: V3i);
  constructor(...args: ReadonlyArray<number | V2i | V3i>) {
  ...
  *[Symbol.iterator](): Iterator<number> {
  ...
  static "+"(a: V4i, b: V4i): V4i { return a.add(b); }
  static "-"(a: V4i, b: V4i): V4i;
  static "-"(a: V4i): V4i;
  static "-"(a: V4i, b?: V4i): V4i { return b ? a.sub(b) : a.neg(); }
  static "*"(a: V4i, b: V4i): V4i;
  static "*"(a: V4i, b: number): V4i;
  static "*"(a: number, b: V4i): V4i;
  static "*"(a: V4i | number, b: V4i | number): V4i {
    if (typeof a === "number") return (b as V4i).mul(a);
    return a.mul(b as V4i | number);
  }
  static "/"(a: V4i, b: V4i): V4i;
  static "/"(a: V4i, b: number): V4i;
  static "/"(a: V4i, b: V4i | number): V4i { return a.div(b); }
